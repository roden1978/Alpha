 ...
 */
public class VirusB extends Microbe {
    ...
    public VirusB(Vector2 position, float speed, int weight, Player player,
    ...
    public void shot(float delta){
        intervalDelta += delta;
                ...
                if (intervalDelta > interval){//изменить тип пуль
                    bullet = new VirusBullet(1,new Vector2 (player.getPositionX(),
